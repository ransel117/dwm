...
static const unsigned char utfbyte[UTF_SIZ + 1] = {0x00000080, 0x00000000, 0x000000C0, 0x000000E0, 0x000000F0};
static const unsigned char utfmask[UTF_SIZ + 1] = {0x000000C0, 0x00000080, 0x000000E0, 0x000000F0, 0x000000F8};
static const long utfmin[UTF_SIZ + 1]           = {0x00000000, 0x00000000, 0x00000080, 0x00000800, 0x00010000};
static const long utfmax[UTF_SIZ + 1]           = {0x0010FFFF, 0x0000007F, 0x000007FF, 0x0000FFFF, 0x0010FFFF};
...
unsigned int drw_fontset_getwidth(Drw *drw, const char *text) {
    return (!drw || !drw->fonts || !text) ? 0 : drw_text(drw, 0, 0, 0, 0, 0, text, 0);
}
