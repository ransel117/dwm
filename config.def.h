...
#define FONT "xft:DejaVu Sans Mono"
static const char *fonts[]    = {FONT":size=10"};
static const char dmenufont[] = FONT":size=10";
static const char nbg[]        = "#282828";
static const char nfg[]        = "#ebdbb2";
static const char sbg[]        = "#458588";
static const char sfg[]        = "#ebdbb2";
static const char *colors[][3]      = {
	/*              fg   bg   border */
	[SchemeNorm] = {nfg, nbg, nbg },
	[SchemeSel]  = {sfg, sbg, nbg},
};
